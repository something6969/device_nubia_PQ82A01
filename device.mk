...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/c2_manifest_vendor_audio_dts.xml:$(TARGET_COPY_OUT_VENDOR)/etc/c2_manifest_vendor_audio_dts.xml \
    $(LOCAL_PATH)/configs/audio/default_audio_logmask.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/default_audio_logmask.cfg \
    $(LOCAL_PATH)/configs/audio/dts_audio_settings:$(TARGET_COPY_OUT_VENDOR)/etc/dts_audio_settings \
    $(LOCAL_PATH)/configs/audio/mixer_paths_kalama_cdp.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_kalama_cdp.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_kalama_cdp_wsa883x.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_kalama_cdp_wsa883x.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_kalama_grd.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_kalama_grd.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_kalama_mtp.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_kalama_mtp.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_kalama_qrd.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_kalama_qrd.xml \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/media/media_codecs_kalama.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_kalama.xml \
    $(LOCAL_PATH)/configs/media/media_codecs_kalama_vendor.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_kalama_vendor.xml \
    $(LOCAL_PATH)/configs/media/media_codecs_performance_kalama.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_performance_kalama.xml \
...
PRODUCT_PACKAGES += \
    ...
    init.vendor.rc \
    init.vendor.usb.rc \
    fstab.enableswap_wb_100_1 \
    fstab.enableswap_wb_100_2 \
    fstab.enableswap_wb_100_3 \
    fstab.enableswap_wb_100_4 \
    fstab.enableswap_wb_100_5 \
    fstab.enableswap_wb_100_6 \
    fstab.enableswap_wb_100_7 \
    fstab.enableswap_wb_100_8 \
    fstab.enableswap_wb_4_1 \
    fstab.enableswap_wb_4_2 \
    fstab.enableswap_wb_4_3 \
    fstab.enableswap_wb_4_4 \
    fstab.enableswap_wb_4_5 \
    fstab.enableswap_wb_4_6 \
    fstab.enableswap_wb_4_7 \
    fstab.enableswap_wb_4_8 \
    fstab.enableswap_wb_50_1 \
    fstab.enableswap_wb_50_2 \
    fstab.enableswap_wb_50_3 \
    fstab.enableswap_wb_50_4 \
    fstab.enableswap_wb_50_5 \
    fstab.enableswap_wb_50_6 \
    fstab.enableswap_wb_50_7 \
    fstab.enableswap_wb_50_8 \
    fstab.enableswap_wb_8_1 \
    fstab.enableswap_wb_8_2 \
    fstab.enableswap_wb_8_3 \
    fstab.enableswap_wb_8_4 \
    fstab.enableswap_wb_8_5 \
    fstab.enableswap_wb_8_6 \
    fstab.enableswap_wb_8_7 \
    fstab.enableswap_wb_8_8 \
    fstab.qcom \
    ueventd.qcom.rc \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/seccomp/codec2.vendor.base.dtscodec.policy:$(TARGET_COPY_OUT_VENDOR)/etc/seccomp_policy/codec2.vendor.base.dtscodec.policy \
    ...
    $(LOCAL_PATH)/configs/seccomp/codec2.vendor.external.dtscodec.policy:$(TARGET_COPY_OUT_VENDOR)/etc/seccomp_policy/codec2.vendor.external.dtscodec.policy \
    $(LOCAL_PATH)/configs/seccomp/gnss@2.0-base.policy:$(TARGET_COPY_OUT_VENDOR)/etc/seccomp_policy/gnss@2.0-base.policy \
    $(LOCAL_PATH)/configs/seccomp/gnss@2.0-qsap-location.policy:$(TARGET_COPY_OUT_VENDOR)/etc/seccomp_policy/gnss@2.0-qsap-location.policy \
    ...
    $(LOCAL_PATH)/configs/seccomp/qsap_dcfd.policy:$(TARGET_COPY_OUT_VENDOR)/etc/seccomp_policy/qsap_dcfd.policy \
    $(LOCAL_PATH)/configs/seccomp/qsap_qapeservice.policy:$(TARGET_COPY_OUT_VENDOR)/etc/seccomp_policy/qsap_qapeservice.policy \
    $(LOCAL_PATH)/configs/seccomp/qsap_sensors.policy:$(TARGET_COPY_OUT_VENDOR)/etc/seccomp_policy/qsap_sensors.policy \
    $(LOCAL_PATH)/configs/seccomp/qsap_voiceui.policy:$(TARGET_COPY_OUT_VENDOR)/etc/seccomp_policy/qsap_voiceui.policy \
    ...
    $(LOCAL_PATH)/configs/seccomp/qwesd@2.0.policy:$(TARGET_COPY_OUT_VENDOR)/etc/seccomp_policy/qwesd@2.0.policy \
...
# Inherit vendor
$(call inherit-product, vendor/nubia/PQ82A01/PQ82A01-vendor.mk)